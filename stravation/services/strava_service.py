    ...
    def list_recent(self, page: int = 1) -> List[Dict]:
        ...
        Retourne une liste normalisée :
          {
            ...
            description,
            distance_km,
            moving_time_s,      # ✅ durée en secondes (à envoyer dans Google Sheets)
            moving_time_min,    # optionnel (confort humain)
            elevation_gain_m,
            start_dt_utc,
            start_local
          }
        ...
        for a in acts:
            ...
            out.append({
                ...
                # ⏱️ DURÉE (clé)
                "moving_time_s": moving_time_s,  # 👉 colonne "Durées (s)"
                "moving_time_min": moving_time_s // 60,  # optionnel
